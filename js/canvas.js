const COLORS = ["255,193,7", "5,117,18", "29,39,57", "67,189,81"];
...
class Bubble {
    ...
    init() {
        ...
        this.size = generateDecimalBetween(3, 12);
        ...
        this.velosity = generateDecimalBetween(20, 40);
        this.movementX = generateDecimalBetween(-2, 2) / this.velosity;
        this.movementY = generateDecimalBetween(1, 20) /this.velosity;
    }
